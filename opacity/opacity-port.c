...
#define GEGL_OP_NAME     opacity_port
#define GEGL_OP_C_SOURCE opacity-port.c
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    ...
    "title",       _("Opacity"),
    "reference-hash", "portb20e8c1d7bb20af95f724191feb10103",
    "description",
          _("Opacity slider that allows opacity values over 100%. This is termed 'hyper opacity'.  "),
    NULL);
}
