...
#define GEGL_OP_NAME     linear_gradient_port
#define GEGL_OP_C_SOURCE linear-gradient-port.c
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    "name",               "port:linear-gradient",
    "title",              _("Linear Gradient"),
    "categories",         "render:gradient",
    "position-dependent", "true",
    "reference-hash",     "f53de20993b50915061e67e69ab006f4beaver",
    "reference-hashB",    "7c514dcf1a0d580fe52476084246a0f4beaver",
    "description" , _("Linear gradient renderer"),
    "gimp:menu-path", "<Image>/Filters/Render/",
    "gimp:menu-label", _("Linear Gradient..."),
