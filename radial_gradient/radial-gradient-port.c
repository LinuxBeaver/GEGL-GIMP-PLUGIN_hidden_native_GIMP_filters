...
property_double (start_x, _("X1"), 25.0)
    value_range (0.0, 1400.0)
    ui_range    (0.0, 1400.0)
    ui_meta("unit", "pixel-coordinate")
    ui_meta("axis", "x")
property_double (start_y, _("Y1"), 25.0)
    value_range (0.0, 900.0)
    ui_range    (0.0, 900.0)
    ui_meta("unit", "pixel-coordinate")
    ui_meta("axis", "y")
...
#define GEGL_OP_NAME     radial_gradient_port
#define GEGL_OP_C_SOURCE radial-gradient-port.c
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
    "name",            "port:radial-gradient",
    "title",           _("Radial Gradient"),
    "categories",      "render:gradient",
    "reference-hash",  "ff1e65a10aea0e973ef6191912137d92beaver",
    "reference-hashB", "3b1c6367858882e778f4dbde0ba0e3d2beaver",
